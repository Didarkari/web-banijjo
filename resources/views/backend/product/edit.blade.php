                        ...
                        <form action="{{ route('product.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input id="inputText3" type="text" name="name" value="{{ $category->name }}"
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <textarea id="short_description" name="short_description"
                                        class="form-control @error('short_description') is-invalid @enderror"> {{ $category->short_description }}</textarea>
                                </div>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <textarea id="product_details" name="product_details"
                                        class="form-control @error('product_details') is-invalid @enderror">{{ $category->product_details }} </textarea>
                                </div>

                                <div class="form-group col-6">
                                    <label for="quantity" class="col-form-label  ">Quantity</label>
                                    <input id="quantity" type="number" name="quantity" value="{{ $category->quantity }}"
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input id="price" type="number" name="price" value="{{ $category->price }}"
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input id="discount" type="number" name="discount" value="{{ $category->discount }}"
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input id="delivery_policy" type="text" name="delivery_policy" value="{{ $category->delivery_policy }}"
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input id="return_policy" type="text" name="return_policy" value="{{ $category->return_policy }}"
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input id="order" type="number" name="order" value="{{ $category->order }}"
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <select class="form-control" id="sub_category" name="sub_category" required>
                                        ...
                                        @foreach ($sub_categories as $sub_category)
                                            <option value="{{ $sub_category->id }}"{{ $category->sub_category_id == $sub_category->id ? 'Selected' : ''}}>{{ $sub_category->name }}</option>
                                        @endforeach
