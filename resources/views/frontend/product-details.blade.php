                    ...
                    <div class="product-details-left">
                        <div class="product-details-images slider-navigation-1">
                            ...
                            @foreach ($product->images as $image)
                                <div class="lg-image">
                                    <a class="popup-img venobox vbox-item" href="{{ asset($image->path) }}"
                                        data-gall="myGallery">
                        ...
                        <div class="product-details-thumbs slider-thumbs-1">
                            @foreach ($product->images as $image)
                            <div class="sm-image"><img src="{{ asset($image->path) }}"
                ...
                <div class="col-lg-7 col-md-6">
                    <div class="product-details-view-content pt-60">
                        <div class="product-info">
                            <h2>{{ $product->name }}</h2>
                            <span class="product-details-ref">{{ $product->short_description }}</span>
                            ...
                            <div class="price-box pt-20">
                                ...
                                <span class="new-price new-price-2">$
                                    ...
                                    // dd($product->price , $discount_price)
                                ...
                                <span class="new-price new-price-2 text-success">$
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="reassurance-item">
                                            ...
                                            <p>Delivery policy ({{ $product->delivery_policy }})</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="reassurance-item">
